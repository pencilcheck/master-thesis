...
tags~\cite{Shepard2005}, sensors, actuators, mobile phones, which would be
...
a monolithic system that executes one instruction at a time contrasts to
...
different access modes, such as \textit{readonly}, \textit{writeonly},
          \textit{readwrite}. Properties on
...
device, which will be determined during deployment, that it is represented by
on or off.
