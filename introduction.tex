...
% emphasizes the difference between other related work, where it is not
% "replication" in the same sense of other related work

% should summarize stateless distributed system to enable no replication in the
% sense of other related work

% should also summarize how it is stateless, and how it is different from other
% distributed systems
